...
from resources.lib.modules import client,cleantitle,source_utils,dom_parser2,cfscrape


class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en'] # Crapcha  moviesonline.gy
        self.domains = ['moviesonline.tl', 'moviesonline.mn', 'moviesonline.la', 'moviesonline.fm', 'moviesonline.mx']

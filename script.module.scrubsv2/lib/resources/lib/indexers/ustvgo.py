...
class ustvgo:
    def __init__(self):
        ...
        self.icon_link = 'https://github.com/jewbmx/xml/blob/master/img/ustvgo.jpg?raw=true'
    ...
    def root(self):
        ...
        for channel in channels:
            ...
            self.list.append({'name': cleanChannel, 'url': self.base_link % channel, 'image': self.icon_link, 'action': 'ustvgoPlay'})

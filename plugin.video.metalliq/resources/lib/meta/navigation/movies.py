...
def make_movie_item(movie_info, is_list = False):
    ...
    if movie_info['poster'] == None or movie_info['poster'] == "": movie_info['poster'] = "https://raw.githubusercontent.com/N2Roar/roar-extras/master/Style/MetalliQ/roar/unavailable.png"
